...
export interface Registry<T = any, S extends StrictRJSFSchema = RJSFSchema, F extends FormContextType = any> {
  ...
  rootSchema: S;
  /** The current implementation of the `SchemaUtilsType` (from `@lonli-lokli/dynamic-forms-utils`) in use by the `Form`.  Used to call any
...
/** The `SchemaUtilsType` interface provides a wrapper around the publicly exported APIs in the `@lonli-lokli/dynamic-forms-utils/schema`
 ...
 * set of APIs to the `@lonli-lokli/dynamic-forms-core` components and the various themes as well.
 */
