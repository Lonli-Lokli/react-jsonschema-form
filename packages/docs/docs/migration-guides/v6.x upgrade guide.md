...
- `@lonli-lokli/dynamic-forms-daisyui`: This is new theme based on the `daisyui` toolkit
- `@lonli-lokli/dynamic-forms-react-bootstrap`: This is rename of the `bootstrap-4` theme with an upgrade to the latest version of `react-bootstrap`
- `@lonli-lokli/dynamic-forms-shadcn`: This is new theme based on the `shadcn` toolkit
...
The `getMatchingOption()` function in `@lonli-lokli/dynamic-forms-utils` was removed. Use the `getFirstMatchingOption()` function instead.
I.e.:

```ts
import { getFirstMatchingOption, RJSFSchema } from '@lonli-lokli/dynamic-forms-utils';
...
```ts
import { createSchemaUtils, RJSFSchema } from '@lonli-lokli/dynamic-forms-utils';
import validator from '@lonli-lokli/dynamic-forms-validator-ajv8';
...
The `mergeValidationData()` function from `@lonli-lokli/dynamic-forms-utils` was removed. Use the `validationDataMerge()` function instead.
I.e.:

```ts
import { validationDataMerge, ValidationData, ErrorSchema } from '@lonli-lokli/dynamic-forms-utils';
...
```ts
import { toErrorList } from '@lonli-lokli/dynamic-forms-utils';
...
from `@lonli-lokli/dynamic-forms-utils` instead. I.e.:

```ts
import { validationDataMerge, ErrorSchema, RJSFValidationError, toErrorList } from '@lonli-lokli/dynamic-forms-utils';
...
The constant `RJSF_ADDITONAL_PROPERTIES_FLAG` was removed from `@lonli-lokli/dynamic-forms-utils`. Use the `RJSF_ADDITIONAL_PROPERTIES_FLAG`
constant instead. I.e.:

```ts
import { RJSF_ADDITIONAL_PROPERTIES_FLAG } from '@lonli-lokli/dynamic-forms-utils';
```
...
```ts
import { UiSchema, RJSFSchema } from '@lonli-lokli/dynamic-forms-utils';
...
The following new types were added to `@lonli-lokli/dynamic-forms-utils`:
...
Three new and three formerly internally private utility functions are available in `@lonli-lokli/dynamic-forms-utils`:
...
Three new validator-based utility functions are available in `@lonli-lokli/dynamic-forms-utils`:
