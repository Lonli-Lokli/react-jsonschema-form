...
In RJSF version 6, the original, embedded AJV 6 validator implementation from earlier versions was removed in favor of the `@lonli-lokli/dynamic-forms-validator-ajv8` package.
`@lonli-lokli/dynamic-forms-validator-ajv8` uses the AJV 8 package, including adding support for using precompiled validators.
