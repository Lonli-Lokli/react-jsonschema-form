...
The components used by `@lonli-lokli/dynamic-forms-material-ui` for Material UI version 4 and version 5 have identical names and props.
...
## Example of a custom widget for `@lonli-lokli/dynamic-forms-material-ui`
...
import { useMuiComponent } from '@lonli-lokli/dynamic-forms-material-ui/v4';
...
## Example of a custom field for `@lonli-lokli/dynamic-forms-material-ui`
