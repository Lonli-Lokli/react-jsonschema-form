...
core-js@2 has been removed from @lonli-lokli/dynamic-forms-core. See more about [the rationale here](https://github.com/rjsf-team/react-jsonschema-form/pull/2211#issue-563700810).
...
If you were directly depending on @lonli-lokli/dynamic-forms-core's @babel/runtime pulling in core-js@2, just `npm install core-js` and using a side effectful import at the top of your entry point (`import 'core-js'`) might be enough.
