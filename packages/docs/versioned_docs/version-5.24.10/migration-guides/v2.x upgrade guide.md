...
- We now officially support the @lonli-lokli/dynamic-forms-material-ui theme. We use a monorepo with Lerna and have published two packages (@lonli-lokli/dynamic-forms-core and @lonli-lokli/dynamic-forms-material-ui) with this version number. Note that react-jsonschema-form has been renamed to @lonli-lokli/dynamic-forms-core ([#1642](https://github.com/rjsf-team/react-jsonschema-form/pull/1642))
