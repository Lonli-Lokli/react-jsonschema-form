 ...
 * `@lonli-lokli/dynamic-forms-utils` OR if an AJV update is installed. To run this, simply do the following, starting in the root directory
 * of the `@lonli-lokli/dynamic-forms-validator-ajv8` directory:
 *
 * - cd test/harness
