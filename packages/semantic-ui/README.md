...
```sh
yarn add semantic-ui-css semantic-ui-react @lonli-lokli/dynamic-forms-core
```

### Installation

```sh
yarn add @lonli-lokli/dynamic-forms-semantic-ui
```
...
```javascript
import Form from '@lonli-lokli/dynamic-forms-semantic-ui';
```
...
import { Theme as SemanticUITheme } from '@lonli-lokli/dynamic-forms-semantic-ui';
...
[npm-shield]: https://img.shields.io/npm/v/@lonli-lokli/dynamic-forms-semantic-ui/latest.svg?style=flat-square
[npm-url]: https://www.npmjs.com/package/@lonli-lokli/dynamic-forms-semantic-ui
[npm-dl-shield]: https://img.shields.io/npm/dm/@lonli-lokli/dynamic-forms-semantic-ui.svg?style=flat-square
[npm-dl-url]: https://www.npmjs.com/package/@lonli-lokli/dynamic-forms-semantic-ui
